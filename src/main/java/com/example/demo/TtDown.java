...
public class TtDown {
    ...
    Object stageSendTTVideo(Message message) {
        HttpRequest request = HttpRequest.newBuilder()
                .uri(URI.create("https://tiktok-download-video1.p.rapidapi.com/getVideo?url="+message.getText()))
        ...
        try {
            ...
            if (response.statusCode() == 200) {
                ...
                String videoUrl = responseJson.get("data").get("play").asText();
